...
commands.updateSettings = async function (settings) {
  ...
  for (let [setting, value] of _lodash.default.toPairs(settings)) {
    if (_baseDriver.BASEDRIVER_HANDLED_SETTINGS.includes(setting)) {
